...
#Hyperparameter  这里如果设置更大就说明 更要考虑过拟合的问题
reg = 10000
...
for i in range(epoches):
    ...
    '''
     Adam
    '''
    det_w1 = 2 * sum_w1 + 2 * reg * w1
    det_w2 = 2 * sum_w2 + 2 * reg * w2
    det_w3 = 2 * sum_w3 + 2 * reg * w3
    det_w4 = 2 * sum_w4 + 2 * reg * w4
    det_w5 = 2 * sum_w5 + 2 * reg * w5
    det_b  = 2 * sum_b
